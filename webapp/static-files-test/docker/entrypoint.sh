...
#   If empty or missing → no-op path (default nginx image)
#
# K8s Secret keys:
...
echo "========================================"
echo "  E2E podman build — Static Files Proxy"
...
echo ""
echo "── Resolve images ────────────────────────────────────────────"
# Static files don't use node, but webapp-build.ts resolves both anyway
...
echo "  _NODE_IMAGE    = $_NODE_IMAGE (unused for static files)"
echo "  _NGINX_DEFAULT = $_NGINX_DEFAULT"
echo "  _NGINX_IMAGE   = $_NGINX_IMAGE"
echo "  _NPM_URL       = ${_NPM_URL:-(not set)} (unused for static files)"
...
echo ""
echo "========================================"
echo "  E2E TEST PASSED (static files, $RUNTIME)"
echo "========================================"
